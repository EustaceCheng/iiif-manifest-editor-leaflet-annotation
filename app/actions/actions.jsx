...
/*add export var*/
export var setMapAidToLid = (mapAidToLid) =>{
  return{
	  type: 'SET_MAP_AID_TO_LID',
	  mapAidToLid
  }
};

export var setCanvasAnnotation = (canvasAnnotation) =>{
  return{
	  type: 'SET_CANVAS_ANNOTATION',
	  canvasAnnotation
  }
};

export var setEditStatus = (editStatus) =>{
  return{
