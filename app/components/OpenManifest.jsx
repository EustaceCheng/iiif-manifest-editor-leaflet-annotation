        ...
        <div className="open-manifest-form-container">
          ...
          <form className="form-horizontal" role="form" onSubmit={this.onFormSubmit}>
            ...
            <div className="row form-group">
              ...
              <div className="col-md-9">
                <input type="url" className="form-control" id="remoteManifestUrl" placeholder="Enter URL for manifest to load" ref="remoteManifestUrl" value="https://wellcomelibrary.org/iiif/b18035723/manifest"/>
